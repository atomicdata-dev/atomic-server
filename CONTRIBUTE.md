...
1. `scp ../target/x86_64-unknown-linux-gnu/release/atomic-server atomic:~/atomic/server/atomic-server-v0.19.0`
1. `ssh atomic`
...
1. `./atomic-server-v0.19.0 &> log-v0.19.0-1` to start and log to file
