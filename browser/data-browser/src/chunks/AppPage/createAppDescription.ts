...
export const CREATE_APP_DESCRIPTION =
  ...
  'THIS IS THE LAST RESORT, NOT THE FIRST. Atomic already renders rows as a table, a kanban board, a calendar and a timer, and those are CONFIGURATION — one configure_view call. They come with drag-and-drop between kanban columns, live sync between people, undo, keyboard navigation, resizable columns and export already working. Anything you write by hand starts with none of that and will not catch up.\n\n' +
