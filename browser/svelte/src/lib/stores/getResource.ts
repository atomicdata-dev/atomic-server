import { type FetchOpts, type OptionalClass, Resource, Store } from '@tomic/lib';
...
export const getResource = <C extends OptionalClass = never>(
	...
	let resource = readable<Resource<C>>(adStore.getResourceLoading(subjectValue, opts), (set) => {
