import { Resource, type InferTypeOfValueInTriple, type OptionalClass } from '@tomic/lib';
import { type Readable, type Writable, get } from 'svelte/store';

import { store } from './store.js';

export type ValueSubscriber<Prop extends string, C extends OptionalClass = never> = (
	value: InferTypeOfValueInTriple<C, Prop>
) => void;
export type ValueUpdater<Prop extends string, C extends OptionalClass = never> = (
	value: InferTypeOfValueInTriple<C, Prop>
